...
exports.getSampleCompanyData = getSampleCompanyData;
...
const datasets = {
    microsoft: {
        profile: {
            ...
            country: "United States",
            currency: "USD",
            description: "Microsoft is a global software, cloud, and enterprise technology company with major businesses in productivity software, Azure cloud, Windows, gaming, and AI infrastructure.",
        },
        metrics: {
    ...
    apple: {
        profile: {
            ...
            country: "United States",
            currency: "USD",
            description: "Apple designs consumer hardware, software, and services, with a high-margin ecosystem built around iPhone, Mac, wearables, payments, and digital services.",
        },
        metrics: {
    ...
    tesla: {
        profile: {
            ...
            country: "United States",
            currency: "USD",
            description: "Tesla manufactures electric vehicles, energy storage systems, charging products, and related software-led services.",
        },
        metrics: {
    ...
    nvidia: {
        profile: {
            ...
            country: "United States",
            currency: "USD",
            description: "NVIDIA designs GPUs, AI accelerators, networking products, and software platforms used in gaming, data centers, professional visualization, and autonomous systems.",
        },
        metrics: {
...
function getSampleCompanyData(companyName) {
    ...
    return {
        profile: {
            ...
            country: "Unknown",
            currency: "Unknown",
            description: "This company could not be matched to a verified public-market listing. The bot should not treat it as investable until a ticker, exchange, and financial data are confirmed.",
            marketStatus: "Unverified",
            securityType: "Unknown",
            resolutionNote: "No verified ticker, exchange, ETF, parent company, public filing, or known private-company match was found.",
        },
        metrics: {
            marketCap: 0,
            revenueGrowthPercent: 0,
